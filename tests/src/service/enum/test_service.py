...
from tests.test_doubles.doubles import enum_service_get_enums_response_ok, enum_service_get_enums_response_invalid, enum_service_get_enums_response_none
from tests.test_doubles.doubles import enum_service_response_ok, enum_service_response_none, enum_service_response_invalid
...
def test_get_response_when_enums_are_invalid(get_enums_mock):
    get_enums_mock.return_value = enum_service_get_enums_response_invalid
    result = EnumService.get_response()
